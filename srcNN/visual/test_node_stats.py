...
import mock
from srcNN.problems.problem_domain import Observation
from srcNN.visual.weight_tracker import NodeStats
from srcNN.experiment.experiment import BinaryObservation
...
class NodeStatsSpec(TestCase):
    ...
    def test_whenSingleNodeWithMultipleWeightsAndExpWithMultipleInstances_ThenUpdateCorrect(self):
        #Mock up the network
        mock_net = mock.create_autospec(Network)
