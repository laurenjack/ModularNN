...
import srcthesis.visual.weight_tracker as wt
import srcthesis.visual.error_drawer as ed
...
def run_saxe(act_strings, l_rates, use_saxe_weights=True):
    ...
    errors = runner.sgd_tracking_error(network, train, 50, 50, eval, wt=mode_stats)

    # Plot mode strengths
    ed.plot_modes(mode_stats)
